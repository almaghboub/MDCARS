...
- **Orders**: Customer order management with items, receiver info, shipping details, down payment tracking, and status workflow (pending → processing → shipped → delivered)
