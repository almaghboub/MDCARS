...
const translations = {
  en: {
    ...
    amountForMethod: "Amount",
    creditPrice: "Credit Price",
    cashPrice: "Cash Price",
    editPrice: "Edit Price",
    originalPrice: "Original Price",
    priceEdited: "Price edited for this item only",
    ...
    paidNow: "Paid Now (Cash/Bank)",
    onCredit: "On Credit (Supplier Payable)",
    supplierName: "Supplier Name",
    invoiceNo: "Invoice Number",
    optional: "Optional",
    totalCost: "Total Cost",
    willDeductFromCashbox: "This amount will be deducted from the cashbox",
    willRecordAsPayable: "This will be recorded as a supplier payable (no cash deducted now)",
    ...
    paidSupplierDebts: "Paid Supplier Debts",
    noUnpaidDebts: "No unpaid supplier debts",
    paidDate: "Paid Date",
    payableMarkedPaid: "Supplier debt marked as paid - amount deducted from cashbox",
    ...
    returnSelected: "Return selected items",
    noItemsSelected: "No items selected for return",
    newItemsToAdd: "New Items",
    ...
    ownershipAutoCalculated: "Ownership % is auto-calculated based on net capital (invested − withdrawn − profit distributed)",
    ...
    orderMarkedAsProcessing: "Order status updated",
    ...
    walkIn: "No Customer",
    fullNameRequired: "Receiver Name *",
    phoneRequired: "Receiver Phone *",
  ...
  ar: {
    ...
    moneyTransfer: "تحويل بنكي",
    paidInFull: "مدفوع بالكامل",
    selectPaymentMethod: "اختر طرق الدفع",
    sellOnCredit: "البيع بالآجل",
    mixed: "دفع مختلط",
    ...
    amountForMethod: "المبلغ",
    creditPrice: "سعر الآجل",
    cashPrice: "السعر النقدي",
    editPrice: "تعديل السعر",
    originalPrice: "السعر الأصلي",
    priceEdited: "تم تعديل السعر لهذا العنصر فقط",
    ...
    adjustment: "تعديل",
    damaged: "تالف",
    damagedStock: "مخزون التالف",
    markAsDamaged: "تحديد كتالف",
    damagedItems: "المنتجات التالفة",
    ...
    paidNow: "مدفوع الآن (نقداً/بنك)",
    onCredit: "على الحساب (ذمم موردين)",
    supplierName: "اسم المورد",
    invoiceNo: "رقم الفاتورة",
    optional: "اختياري",
    totalCost: "التكلفة الإجمالية",
    willDeductFromCashbox: "سيتم خصم هذا المبلغ من الصندوق",
    willRecordAsPayable: "سيتم تسجيله كذمة مورد (لن يتم خصم نقدي الآن)",
    ...
    paidSupplierDebts: "ديون الموردين المدفوعة",
    noUnpaidDebts: "لا توجد ديون موردين غير مدفوعة",
    paidDate: "تاريخ الدفع",
    payableMarkedPaid: "تم تحديد دين المورد كمدفوع - تم خصم المبلغ من الصندوق",
    ...
    editInvoiceDesc: "إرجاع منتجات وإضافة بدائل",
    itemsToReturn: "المنتجات للإرجاع",
    selectItemsToReturn: "اختر المنتجات للإرجاع",
    addNewItems: "إضافة منتجات جديدة",
    searchAndAddProducts: "ابحث وأضف منتجات",
    returnSelected: "إرجاع المنتجات المحددة",
    noItemsSelected: "لم يتم تحديد منتجات للإرجاع",
    newItemsToAdd: "منتجات جديدة",
    currentItems: "المنتجات الحالية",
    saveChanges: "حفظ التغييرات",
    invoiceEdited: "تم تعديل الفاتورة بنجاح",
    priceDifference: "فرق السعر",
    refundToCustomer: "استرداد",
    additionalCharge: "رسوم إضافية",
    addToInvoice: "إضافة",
    keepItems: "المنتجات المحتفظ بها",
    returnItems: "إرجاع المنتجات",
    ...
    ownershipAutoCalculated: "نسبة الملكية تحسب تلقائياً بناءً على صافي رأس المال (المستثمر − المسحوب − الأرباح الموزعة)",
    ...
    noOrdersMatch: "لا توجد طلبات تطابق البحث",
    filterByStatus: "تصفية حسب الحالة",
    orderStatus: "الحالة",
    orderNumber: "رقم الطلب",
    orderCreatedSuccess: "تم إنشاء الطلب بنجاح",
    failedCreateOrder: "فشل في إنشاء الطلب",
    orderUpdatedSuccess: "تم تحديث الطلب بنجاح",
    failedUpdateOrder: "فشل في تحديث الطلب",
    orderDeletedSuccess: "تم حذف الطلب بنجاح",
    failedDeleteOrder: "فشل في حذف الطلب",
    orderMarkedAsProcessing: "تم تحديث حالة الطلب",
    deleteOrderTitle: "حذف الطلب",
    deleteOrderConfirmation: "هل أنت متأكد من حذف هذا الطلب؟",
    ...
    walkIn: "بدون عميل",
    fullNameRequired: "اسم المستلم *",
    phoneRequired: "هاتف المستلم *",
    ...
    shippingCategory: "نوع الشحن",
    shippingCost: "تكلفة الشحن ($)",
    shippingCostLabel: "تكلفة الشحن:",
    shippingWeightKg: "الوزن (كجم)",
    lydExchangeRate: "سعر صرف الدينار",
    downPaymentOptional: "الدفعة المقدمة (اختياري)",
    downPaymentLabel: "الدفعة المقدمة",
    orderItems: "عناصر الطلب",
    addItem: "إضافة عنصر",
    productNameNumber: "اسم المنتج",
    unitPriceDollar: "السعر ($)",
    orderNotesLabel: "ملاحظات",
    orderNotes: "ملاحظات الطلب...",
    totalOrderAmount: "إجمالي العناصر",
    ...
    orderUpdatesTitle: "تحديثات الطلبات",
    totalInLYD: "الإجمالي بالدينار",
  },
} as const;
