...
import { LayoutDashboard, Package, Users, ShoppingCart, Wallet, BarChart3, Settings, LogOut, Menu, Boxes, AlertTriangle, FileText, RotateCcw, ShoppingBag } from "lucide-react";
...
const navigationItems = [
  ...
  { labelKey: "returns" as const, href: "/returns", icon: RotateCcw, roles: ["owner", "cashier"] },
  { labelKey: "orders" as const, href: "/orders", icon: ShoppingBag, roles: ["owner", "cashier"] },
